...
class UserController {
        ...
        this.fromEl.addEventListener("submit", (event) => {
            ...
            this.getPhoto(this.fromEl).then(
                ...
                (content) => {
                    ...
                    // Recebemos o usuário no retorno da promese
    ...
    selectAll() {
        ...
        // Não precisamos instanciar pois o método é "static"
        // Refatorando com o Ajax. Isso erá retornar uma "Promise"
        User.getUsersStorage().then(data => {

            // Quando ele faz o parse, temos um "nó", que é o nosso "users" (que são os nossos usuários)
    ...
    // **************************************************************************************** //
        ...
        // ************ Quando buscávamos no LocalStorage ***************************************** //
